...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Engine-Decimal%2520Precision-green.svg" alt="Decimal Precision">
...
🖥️ Running the Streamlit UI & Database DashboardTo launch the interactive multiplex counter dashboard and review live SQLite transaction logs:Bash# Install Streamlit (if not already installed)
